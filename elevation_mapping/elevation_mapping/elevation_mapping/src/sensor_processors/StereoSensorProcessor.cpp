...
StereoSensorProcessor::StereoSensorProcessor(rclcpp::Node::SharedPtr nodeHandle, const SensorProcessorBase::GeneralParameters& generalParameters)
...
bool StereoSensorProcessor::readParameters() {
  ...
  nodeHandle_->declare_parameter("sensor_processor/p_1", 0.0);
  nodeHandle_->declare_parameter("sensor_processor/p_2" ,0.0);
  nodeHandle_->declare_parameter("sensor_processor/p_3", 0.0);
  nodeHandle_->declare_parameter("sensor_processor/p_4", 0.0);
  nodeHandle_->declare_parameter("sensor_processor/p_5", 0.0);
  nodeHandle_->declare_parameter("sensor_processor/lateral_factor", 0.0);
  nodeHandle_->declare_parameter("sensor_processor/depth_to_disparity_factor", 0.0);
  nodeHandle_->declare_parameter("sensor_processor/cutoff_min_depth", parameters.sensorParameters_["cutoff_min_depth"]);
  nodeHandle_->declare_parameter("sensor_processor/cutoff_max_depth", parameters.sensorParameters_["cutoff_max_depth"]);

  nodeHandle_->get_parameter("sensor_processor/p_1", parameters.sensorParameters_["p_1"]);
  nodeHandle_->get_parameter("sensor_processor/p_2", parameters.sensorParameters_["p_2"]);
  nodeHandle_->get_parameter("sensor_processor/p_3", parameters.sensorParameters_["p_3"]);
  nodeHandle_->get_parameter("sensor_processor/p_4", parameters.sensorParameters_["p_4"]);
  nodeHandle_->get_parameter("sensor_processor/p_5", parameters.sensorParameters_["p_5"]);
  nodeHandle_->get_parameter("sensor_processor/lateral_factor", parameters.sensorParameters_["lateral_factor"]);
  nodeHandle_->get_parameter("sensor_processor/depth_to_disparity_factor", parameters.sensorParameters_["depth_to_disparity_factor"]);
  nodeHandle_->get_parameter("sensor_processor/cutoff_min_depth", parameters.sensorParameters_["cutoff_min_depth"]);
  nodeHandle_->get_parameter("sensor_processor/cutoff_max_depth", parameters.sensorParameters_["cutoff_max_depth"]);
  return true;
}
