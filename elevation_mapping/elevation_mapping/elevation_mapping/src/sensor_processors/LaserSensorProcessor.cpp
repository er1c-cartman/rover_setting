...
LaserSensorProcessor::LaserSensorProcessor(rclcpp::Node::SharedPtr nodeHandle, const SensorProcessorBase::GeneralParameters& generalParameters)
...
bool LaserSensorProcessor::readParameters() {
  ...
  nodeHandle_->get_parameter("sensor_processor/min_radius", parameters.sensorParameters_["min_radius"]);
  nodeHandle_->get_parameter("sensor_processor/beam_angle", parameters.sensorParameters_["beam_angle"]);
  nodeHandle_->get_parameter("sensor_processor/beam_constant", parameters.sensorParameters_["beam_constant"]);
  return true;
}
