...
StructuredLightSensorProcessor::StructuredLightSensorProcessor(rclcpp::Node::SharedPtr nodeHandle,
...
bool StructuredLightSensorProcessor::readParameters() {
  ...
  nodeHandle_->declare_parameter("sensor_processor/normal_factor_a", 0.0);
  nodeHandle_->declare_parameter("sensor_processor/normal_factor_b", 0.0);
  nodeHandle_->declare_parameter("sensor_processor/normal_factor_c", 0.0);
  nodeHandle_->declare_parameter("sensor_processor/normal_factor_d", 0.0);
  nodeHandle_->declare_parameter("sensor_processor/normal_factor_e", 0.0);
  nodeHandle_->declare_parameter("sensor_processor/lateral_factor",  0.0);
  nodeHandle_->declare_parameter("sensor_processor/cutoff_min_depth",std::numeric_limits<double>::min());
  nodeHandle_->declare_parameter("sensor_processor/cutoff_max_depth", std::numeric_limits<double>::max());

  nodeHandle_->get_parameter("sensor_processor/normal_factor_a", parameters.sensorParameters_["normal_factor_a"]);
  nodeHandle_->get_parameter("sensor_processor/normal_factor_b", parameters.sensorParameters_["normal_factor_b"]);
  nodeHandle_->get_parameter("sensor_processor/normal_factor_c", parameters.sensorParameters_["normal_factor_c"]);
  nodeHandle_->get_parameter("sensor_processor/normal_factor_d", parameters.sensorParameters_["normal_factor_d"]);
  nodeHandle_->get_parameter("sensor_processor/normal_factor_e", parameters.sensorParameters_["normal_factor_e"]);
