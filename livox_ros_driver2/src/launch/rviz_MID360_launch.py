...
def generate_launch_description():
    ...
    pointcloud_filter_config = os.path.join(
        get_package_share_directory('pointcloud_filter'),
        'config',
        'pointcloud_filter_config.yaml'
    )
    
    custom_pointcloud_filter_config = os.path.join(
        get_package_share_directory('pointcloud_filter'),
        'config',
