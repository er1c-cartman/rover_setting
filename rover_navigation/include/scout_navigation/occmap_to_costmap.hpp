...
private:
    ...
    void publishCostmap();
    void clearCenterCosts(nav2_costmap_2d::Costmap2D* costmap);
    void clearCenterPeriodically(); // New function for periodic clearing
    ...
    rclcpp::TimerBase::SharedPtr timer_; // Timer for periodic clearing
};
